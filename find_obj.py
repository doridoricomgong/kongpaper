...
def main():
    ...
    img1copy = cv.imread('./Open/t30/5.jpg', cv.IMREAD_GRAYSCALE)
    img1copy = cv.resize(img1copy, dsize=(800, 500), interpolation=cv.INTER_AREA)
    #img1 = img1copy[150:400,150:750]
    img1 = img1copy
    img2copy = cv.imread('./Open/t30/5.jpg', cv.IMREAD_GRAYSCALE)
    img2copy = cv.resize(img2copy, dsize=(800, 500), interpolation=cv.INTER_AREA)
    #img2 = img2copy[150:400,150:750]
    img2 = img2copy
